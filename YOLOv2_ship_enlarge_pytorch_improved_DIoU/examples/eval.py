...
def voc_eval(detpath,
    ...
    if not os.path.isfile(cachefile):
        ...
        for i, imagename in enumerate(imagenames):
            ...
            #print(imagenames)
            recs[imagename] = parse_rec("E:/paper6/Seaships_new/VOCdevkit/VOC2007"
    ...
    detfile="F:\pycharm\YOLOv2_ship_enlarge_pytorch_improved_DIoU\\results\\"+detfile
...
def get_voc_P_results_file_template(cls):#  P 结果保存的路径以及文件名
    ...
    filename = 'det_' + 'P' + '_yolov2_enlarge_improved_DIoU'+ '_%s.txt' % (cls)
...
def get_voc_R_results_file_template(cls):#  R  结果保存的路径以及文件名
    # VOCdevkit/VOC2007/results/det_test_aeroplane.txt
    filename = 'det_' + 'R' +  '_yolov2_enlarge_improved_DIoU'+ '_%s.txt' % (cls)
...
if __name__ == '__main__':
    # args = parse_args()
    voc_dir = 'E:/paper6/Seaships_new/VOCdevkit'
