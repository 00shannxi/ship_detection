...
nvcc_compile_args = ['-O3', '--ptxas-options=-v', '-arch=sm_35', '-c', '--compiler-options=-fPIC']#CUDA10.1
...
cudamat_ext = Extension('nms.gpu_nms',
                        ...
                        include_dirs = [numpy_include, r'C:\Program Files\\NVIDIA GPU Computing Toolkit\CUDA\\v10.1\include'])
