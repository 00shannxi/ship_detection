...
#E:/paper6/Seaships_7000/VOCdevkit/VOC2007\JPEGImages\006971
#得到预测的所有的位置坐标和置信度
def reorgDetection(dets, netw, neth): #, prefix):     #netw  neth 为输入的测试图像尺寸  416 416
    ...
    for k, v in dets.items():
        ...
        #name = k.split('/')[-1]
        # name = k.split('/')[-1][:-4]   #F:\pycharm\YOLOv2_ship_pytorch\data\Seaships_7000\VOCdevkit\VOC2007\JPEGImages\006971
        name = k[53:-4]  #79     E:/paper6/Seaships_7000/VOCdevkit/VOC2007/JPEGImages/    此路径的字符数为53
