...
#19558332860469818}]}
    ...
    # voc_wrapper.genResults(reorg_dets, results, nms_thresh)
        for k, v in det.items():  #遍历字典   k为图片  v为检测结果   遍历一个batch里的16张图  一次遍历一幅图
            ...
            name = k[53:-4]   #表示只保留006971， 53表示E:/paper6/Seaships_7000/VOCdevkit/VOC2007/JPEGImages/的字符数，-4表示去掉.jpg
            ...
            cv2.imwrite('F:\pycharm\YOLOv2_ship_pytorch_improved_GIoU\show_ship\%s.jpg' % (name), fd)